...
cum.plot <- ggplot(data=states.final, aes(x=Days_100, y=Total_Cases, group=State, color=State)) +
          ...
          #  scale_color_brewer(palette = 'Paired') + 
            ...
            scale_x_continuous('Days since the 100th case', limits=c(0,85)) + 
...
cum.plot2 <- ggplot(data=states.final, aes(x=Days_100, y=Total_Cases, group=State, color=State)) +
          ...
          #   scale_color_brewer(palette = 'Paired') +
             scale_colour_manual(name= "State", values= colors16) +
             scale_x_continuous(name='Days since the 100th case', limits=c(0,85)) + 
...
per100.plot <- ggplot(data=states16.final, aes(x=Days_100, y=Per100, group=State, color=State)) +
            ...
            # scale_color_brewer(palette = 'Paired') +
            scale_colour_manual(name= "State", values= colors16) +
            scale_x_continuous('Days since 100 cases', limits=c(0,85)) + 
...
deaths.plot <- ggplot(data=deaths.final, aes(x=DeathsDays_5, y=Deaths, group=State, color=State)) +
  ...
  # scale_color_brewer(palette = 'Paired') +
   scale_colour_manual(name= "State", values= colors16) +
   scale_x_continuous('Days since 5 deaths', limits=c(0,85)) + 
