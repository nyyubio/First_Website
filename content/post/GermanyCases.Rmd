...
```{r cum_per100, echo = F, message = F, fig.width=8, fig.height=4}
...
```{r new_cases5days, echo = F, message = F, fig.width=8, fig.height=4}
...
```{r cum_deaths, echo = F, message = F, fig.width=8, fig.height=4}
